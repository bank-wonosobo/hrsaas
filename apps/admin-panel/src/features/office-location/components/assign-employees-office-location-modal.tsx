...
export function AssignEmployeesOfficeLocationModal({ officeLocation }: Props) {
  ...
  const handleSubmit = () => {
    mutation.mutate(
      { officeLocationId: officeLocation.id, employeeIds: selected },
  ...
  return (
    <>
      ...
      <Modal
        ...
        title={`Assign Karyawan — ${officeLocation.name}`}
        maxWidth="sm"
      >
